...
/**
 * WhatsApp Message with undocumented group fields present at runtime.
 * `author` is the sender's JID in group messages; `notifyName` is the
 * display name set on the sender's device.
 */
