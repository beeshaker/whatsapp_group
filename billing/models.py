...
class Client(Base):
    ...
    billing_only_started_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    last_warning_sent_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True), nullable=True)
    data_retention_days: Mapped[int] = mapped_column(Integer, nullable=False, default=90)
    pre_expiry_14_warned: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    pre_expiry_2_warned: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
