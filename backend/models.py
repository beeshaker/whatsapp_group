...
class Incident(Base):
    ...
    lead_agent: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ...
    lead_location: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    lead_budget: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
